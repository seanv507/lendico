select 
    ...
    coalesce(in_arrears_since_days_7_plus_first,latest_date)-payout_date as surv_time_7,
    coalesce(in_arrears_since_days_14_plus_first,latest_date)-payout_date as surv_time_14,
    coalesce(in_arrears_since_days_30_plus_first,latest_date)-payout_date as surv_time_30,
    coalesce(in_arrears_since_days_60_plus_first,latest_date)-payout_date as surv_time_60,
    coalesce(in_arrears_since_days_90_plus_first,latest_date)-payout_date as surv_time_90,
    (in_arrears_since_days_7_plus_first is not null)::int as late_7,
    (in_arrears_since_days_14_plus_first is not null)::int as late_14,
    (in_arrears_since_days_30_plus_first is not null)::int as late_30,
    (in_arrears_since_days_60_plus_first is not null)::int as late_60,
    (in_arrears_since_days_90_plus_first is not null)::int as late_90
FROM (
	select  
		p.fk_loan,
		p.loan_request_nr, 
