...
__declspec(dllexport) int __stdcall calcSurvival(double *survival_rates, double * default_rates, int duration, double pd_year);
__declspec(dllexport) double __stdcall polyval(double * coefficients, int n_coefficients, double x, int min_order);
__declspec(dllexport) int __stdcall calcPayments(double * payments, double * survival_rates, double * default_rates,
	int ir_bp, int duration, TAmount amount, TAmount * rr_thresholds, double * recovery_rates, int n_recovery_rates);
__declspec(dllexport) double __stdcall InvestorNPV(double duration, double PD, TAmount amount, double base_rate, double nominal_rate, double service_fee, TAmount rr_threshold1, double recovery_rate1,
	TAmount rr_threshold2, double recovery_rate2);
__declspec(dllexport) double __stdcall  NominalRate(int duration, double PD, TAmount amount, double base_rate, double service_fee,
...
*/ 
__declspec(dllexport) int calcSurvival(double *survival_rates,double *default_rates, int duration, double pd_year){
	double tau = 1/12.0;
...
__declspec(dllexport) int __stdcall calcPayments(double * payments, double * survival_rates, double * default_rates, int ir_bp, int duration, TAmount amount, TAmount * rr_thresholds, double * recovery_rates, int n_recovery_rates){
	double tau = 1/12.0;
...
__declspec(dllexport) double __stdcall NominalRate(int duration, double PD, TAmount amount, double base_rate, double service_fee, TAmount rr_threshold1, double recovery_rate1,
	TAmount rr_threshold2, double recovery_rate2){
	double df;
	int n_recovery_rates = 2;
...
__declspec(dllexport) int __stdcall calcRates(double * results, double * base_rates, double * borrower_fees,
